...
public class Villa extends Facility {
    ...
    public Villa(String serviceId, String serviceName, double area, double price, int maximumNumberOfPeople, String rentalType, String roomStandard, double areaSwimmingPool, int floor) {
